...
def showDependency(email):
        if request.method=='GET':
                ...
                print(programmeList)
                return render_template('showDependency.html',programmeList = programmeList,final_relation = '' ,email=email,function="DEPENDENCY",Wtype="student") 
        else:
                ...
                return render_template('showDependency.html',final_relation = final_relation,email=email,function="DEPENDENCY",Wtype="student")
